...
<html>
  ...
  <body>
    <div class='container pt-5'>
      <h1 class='text-center text-primary'>Rishikesh Fireworks</h1><hr>
      <?php
          ...
          <div class='col-md-12'>
            ...
            <table class='table table-bordered'>
              ...
              <tbody id='product_tbody'>
                <tr>
                  <td><input type='text' required name='hsn[]' class='form-control'></td>
                  <td><input type='text' required name='pname[]' class='form-control'></td>
                  <td><input type='text' required name='qty[]' class='form-control price'></td>
                  <td><input type='text' required name='uom[]' class='form-control qty'></td>
                  <td><input type='text' required name='rate[]' class='form-control qty'></td>
    ...
    <script>
      $(document).ready(function(){
        ...
        $("#btn-add-row").click(function(){
          var row="<tr> <td><input type='text' required name='hsn[]' class='form-control'></td> <td><input type='text' required name='pname[]' class='form-control'></td>  <td><input type='text' required name='qty[]' class='form-control qty'></td> <td><input type='text' required name='uom[]' class='form-control'></td> <td><input type='text' required name='price[]' class='form-control price'></td> <td><input type='text' required name='total[]' class='form-control total'></td> <td><input type='button' value='x' class='btn btn-danger btn-sm btn-row-remove'> </td> </tr>";
